...
export const manifest: ManifestOptions = {
  name: 'Lotería de Panamá',
  short_name: 'La lotería',
  background_color: '#263679',
  theme_color: '#263679',
  description: 'Aplicación para mostrar los números jugados en la Lotería Nacional de Panamá',
  icons: icons,
  display: 'standalone',
  lang: 'es',
  start_url: '/',
